 ...
 * Jd4rider as my meteor username/module, and
 * ChatController for my controllername
 */
Namespace('Jd4rider.ChatController');
 ...
 */
Jd4rider.ChatController = Meteoris.Controller.extend({
    /*
    ...
    getAll: function() {
        return Jd4rider.Chat.find(this.getCriteria(), this.getSortLimit());
    },
    ...
    post: function(t) {
        ...
        Jd4rider.Chat.insert(doc, function(err, _id) {
            if (err) {
